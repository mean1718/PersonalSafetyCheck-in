...
class AppBottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // A thin decorative sliver of the same skyline used elsewhere in
        // the app (Add Contact, Login) — sits above the bar itself so it
        // never risks the icons/labels' legibility, just a consistent
        // brand touch on every screen that uses this shared nav.
        SizedBox(
          height: 26,
